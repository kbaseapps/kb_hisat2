SERVICE = kb_hisat2
SERVICE_CAPS = kb_hisat2
SPEC_FILE = kb_hisat2.spec
URL = https://kbase.us/services/kb_hisat2
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
build-test-script:
    ...
    echo 'cp -R /kb/module/lib/kb_hisat2/ /kb/module/work/kb/module/lib/' >> $(TEST_DIR)/$(TEST_SCRIPT_NAME)
